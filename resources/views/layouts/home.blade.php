...
<head>
    ...
    <!-- swiper css -->
    <link rel="stylesheet" type="text/css" href="{{asset('files\bower_components\swiper\css\swiper.min.css')}}">
    <!-- Style.css -->
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            ...
                            @else
                                <ul class="nav-right">
                                    <li>
                                        <a href="{{ route('login') }}" class="btn btn-grd-primary btn-lg">Login</a>
                                        @if (Route::has('register'))
                                            <a href="{{ route('register') }}" class="btn btn-grd-success btn-lg">Register</a>
                                        @endif
                                    </li>
                                </ul>
